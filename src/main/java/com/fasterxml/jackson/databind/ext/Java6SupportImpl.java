...
public class Java6SupportImpl extends Java6Support
{
    @SuppressWarnings("unused") // compiler warns, just needed side-effects
    private final Class<?> _bogus;

    public Java6SupportImpl() {
        // Trigger loading of annotations that only JDK 6 has, to trigger
        // early fail (see [databind#2466])
        _bogus = ConstructorProperties.class;
    }
